...
public interface Printer extends com.zeroc.Ice.Object
{
    ...
    String fibonacciString(String n, com.zeroc.Ice.Current current);
    ...
    **/
     ...
     * @return -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_fibonacciString(Printer obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
        String iceP_n;
        ...
        inS.endReadParams();
        String ret = obj.fibonacciString(iceP_n, current);
        ...
        throws com.zeroc.Ice.UserException
    {
        ...
        switch(pos)
        {
            case 0:
            {
                return _iceD_fibonacciString(this, in, current);
            }
            case 1:
            {
